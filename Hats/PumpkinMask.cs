...
namespace DeluxeHats.Hats
{
    public static class PumpkinMask
    {
        ...
        public static string DisplayedName =>
                      HatService.Helper.Translation.Get("pumpkin-mask.name");

        public static string DisplayedDescription =>
                      HatService.Helper.Translation.Get("pumpkin-mask.description");
        ...
        public static void Activate()
        {
            ...
            if (daredevil == null)
            {
                ...
                daredevil.displayName = HatService.Translation.Get("daredevil-name");
