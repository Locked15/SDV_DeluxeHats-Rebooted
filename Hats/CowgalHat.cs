...
namespace DeluxeHats.Hats
{
    public static class CowgalHat
    {
        ...
        public static string DisplayedName =>
                      HatService.Helper.Translation.Get("cowgal-hat.name");

        public static string DisplayedDescription =>
                      HatService.Helper.Translation.Get("cowgal-hat.description");
                ...
                if (Game1.player.isRidingHorse())
                {
                    if (horseBuff == null)
                    {
                        horseBuff = new(
                            ...
                            minutesDuration: 1,
                            source: "Deluxe Hats",
                            displaySource: HatService.Translation.Get("cowgal-hat.name"))
                        {
