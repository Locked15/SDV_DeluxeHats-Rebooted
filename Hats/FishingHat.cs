...
namespace DeluxeHats.Hats
{
    public static class FishingHat
    {
        ...
        public static string DisplayedName =>
                      HatService.Helper.Translation.Get("fishing-hat.name");

        public static string DisplayedDescription =>
                      HatService.Helper.Translation.Get("fishing-hat.description");
            ...
            HatService.OnUpdateTicked = (e) =>
            {
                ...
                if (fishingBuff == null)
                {
                    fishingBuff = new(
                        ...
                        minutesDuration: 1,
                        source: "Deluxe Hats",
                        displaySource: HatService.Translation.Get("fishing-hat.name"))
                    {
                        which = HatService.BuffId,
                        description = $"{HatService.Translation.Get("buffs.shaded")}\n" +
