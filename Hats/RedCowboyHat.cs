...
namespace DeluxeHats.Hats
{
    public static class RedCowboyHat
    {
        ...
        public static string DisplayedName =>
                      HatService.Helper.Translation.Get("red-cowboy-hat.name");

        public static string DisplayedDescription =>
                      HatService.Helper.Translation.Get("red-cowboy-hat.description");
                ...
                if (Game1.player.isRidingHorse())
                {
                    if (horseBuff == null)
                    {
                        horseBuff = new(
                            ...
                            minutesDuration: 1,
                            source: "Deluxe Hats",
                            displaySource: HatService.Translation.Get("red-cowboy-hat.name"))
                        {
